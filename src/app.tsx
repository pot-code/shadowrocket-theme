...
const HomeScreen: React.FunctionComponent<{ scheme: { [key: string]: string } }> = props => {
  const {
    NavigationBarColor,
...
const Actions: React.FunctionComponent<{
  ButtonlconColor: string
  TextLabelTextColor: string
  DetaillLabelTextColor: string
  TableCellBackgroundColor: string
}> = props => (
  <div styleName="actions">
    <TableCell icon={<IoIosRocket color={props.ButtonlconColor} />} color={props.TableCellBackgroundColor}>
      <div styleName="connection">
        <span>已连接</span>
        <div styleName="toggle" style={{ backgroundColor: props.ButtonlconColor }}></div>
      </div>
    </TableCell>
    <TableCell icon={<GiShipWheel color={props.ButtonlconColor} />} color={props.TableCellBackgroundColor}>
    ...
    <TableCell icon={<GiSpeedometer color={props.ButtonlconColor} />} color={props.TableCellBackgroundColor}>
      延迟测试
    </TableCell>
  </div>
)
...
const Servers: React.FunctionComponent<{
  ...
  <div styleName="servers">
    <Server
      ...
      iconColor={props.ButtonlconColor}
      address="timeout"
      selected
